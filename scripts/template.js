function getSmallPokemonCardTemplate(pokemon, typesArray, footerHtmlString) {
  return `<div class="card text-bg-dark smallCard-width h-100">
      ...
      <div class="card-body position-relative d-flex justify-content-center smallCard-body-height bg-type-${typesArray[0].name} p-0">
        <img src="${pokemon.image}" class="smallCard-img w-75" data-id="card-image">
      </div>
